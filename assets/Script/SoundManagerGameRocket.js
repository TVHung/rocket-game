            ...
            switch (command) {
                case "onClick":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[0],
                        loop
                    );
                    break;
                case "trueClick":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[8],
                        loop
                    );
                    break;
                case "wrongClick":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[1],
                        loop
                    );
                    break;
                case "lose":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[2],
                        loop
                    );
                    break;
                case "win":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[3],
                        loop
                    );
                    break;
                case "batdau":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[4],
                        loop
                    );
                    break;
                case "tieptuc":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[5],
                        loop
                    );
                    break;
                case "hoanthanh":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[6],
                        loop
                    );
                    break;
                case "cancogang":
                    this._EffectId = cc.audioEngine.playEffect(
                        this.audioClipPool[7],
                        loop
                    );
                    break;
                default:
